...
/* The local FreeType override is compiled next to the SDK LVGL tree. Some
 * include paths load the SDK public FreeType header first; it uses the same
 * LV_FREETYPE_H guard but does not name the monochrome bitmap mode. */
